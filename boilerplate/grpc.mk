...
# protoc-gen-cobra
LIB_GOGRPCCOBRA_REPO=				github.com/amplify-edge/protoc-gen-cobra
LIB_GOGRPCCOBRA_REPO_FSPATH=		$(GOPATH)/src/$(LIB_GOGRPCCOBRA_REPO)
LIB_GOGRPCCOBRA_REPO_VERSION= 		v0.4.0
...
ifeq ($(GO_OS), linux)
	...
	@echo
	@echo -- GRPC-OS check : end --
	@echo

## All
grpc-all: grpc-oscheck
...
grpc-which:
	...
	@echo
	@echo -- protoc-gen-cobra --
	@which protoc-gen-cobra
	@echo
...
grpc-all-git-clone:
	...
	# protoc-gen-cobra
	git clone https://$(LIB_GOGRPCCOBRA_REPO) $(LIB_GOGRPCCOBRA_REPO_FSPATH)
	##cd $(LIB_GOGRPCCOBRA_REPO_FSPATH) && git checkout $(LIB_GO_REPO_VERSION)
...
grpc-all-git-delete:
	...
	rm -rf $(LIB_GOGRPCCOBRA_REPO_FSPATH)
...
grpc-all-vscode-add:
	...
	code --add $(LIB_GOGRPCCOBRA_REPO_FSPATH) --reuse-window
...
grpc-go-build:
	...
	# Golang protoc-gen-cobra
	cd $(LIB_GOGRPCCOBRA_REPO_FSPATH) && go install .
